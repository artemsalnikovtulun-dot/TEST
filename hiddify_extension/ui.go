...
func (e *TEST) setFormData(data map[string]string) error {
...
func (e *TEST) getRunningUI() ui.Form {

	return ui.Form{
		Title:       "TEST",
		Description: "Awesome Extension test created by artemsalnikovtulun-dot",
		Fields: [][]ui.FormField{
			{{
...
func (e *TEST) getStoppedUI() ui.Form {
	// Inital page
	return ui.Form{
		Title:       "TEST",
		Description: "Awesome Extension test created by artemsalnikovtulun-dot",
...
func (e *TEST) addAndUpdateConsole(message ...any) {
